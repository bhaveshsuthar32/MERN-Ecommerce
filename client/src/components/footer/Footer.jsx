    ...
    <footer className="dark:bg-gray-900  bg-gray-200 text-gray-800 py-20 lg:py-20 px-16 font-sans dark:mt-0 mt-10  bottom-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex items-center lg:justify-center">
          <a href='#'>
            <h1 className='font-extrabold text-3xl dark:text-white'>FashionFleet</h1></a>
        </div>
      </div>
      <hr className="my-8 border-gray-700" />
      <div className="sm:flex sm:items-center sm:justify-between sm:flex-row">
        <p className='dark:text-gray-400 text-sm sm:order-1'>© 2024<a href='https://readymadeui.com/' target='_blank' className="hover:underline mx-1">FashionFleet</a>All Rights Reserved.</p>
